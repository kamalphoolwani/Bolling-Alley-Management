...
public class Lane extends Thread implements PinsetterObserver {	
	...
	// Party Assigned and Game Not Finished
	public void assignedParty_gameFinished() {
	...
	// Party Assigned and Game Not Finished
	public void assignedParty_gameNotFinished() {
		while (gameIsHalted) {
			try {
				sleep(10);
			} catch (Exception e) {}
	...
	public void run() {
		...
		while (true) {
			if (partyAssigned && !gameFinished) {	// we have a party on this lane, 
				...
				assignedParty_gameNotFinished();

			} else if (partyAssigned && gameFinished) {
				assignedParty_gameFinished();
			}
			try {
				sleep(10);
			} catch (Exception e) {}
